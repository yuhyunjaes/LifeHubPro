    ...
    return (
        <div className="flex justify-between">
            <div className="space-x-3 text-sm sm:text-base">
                <button onClick={() => {
                    setTap("all");
                }} className={`font-semibold space-x-1 rounded-2xl cursor-pointer transition-colors duration-300 ${tap === "all" ? "normal-text" : "text-gray-500 hover:text-gray-950 dark:hover:text-white"}`}>
                    <FontAwesomeIcon icon={faLayerGroup}/>
                    <span>전체</span>
                </button>
                <button onClick={() => {
                    setTap("liked");
                }} className={`font-semibold space-x-1 rounded-2xl cursor-pointer transition-colors duration-300 ${tap === "liked" ? "normal-text" : "text-gray-500 hover:text-gray-950 dark:hover:text-white"}`}>
