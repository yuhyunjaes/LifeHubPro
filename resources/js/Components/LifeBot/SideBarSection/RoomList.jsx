...
export default function RoomList({ sideBar = false, auth, setLoading, setRooms, rooms, setChatId, chatId }) {
    ...
    return (
        <div className={`my-3 ${sideBar ? "block" : "hidden"}`}>
            ...
            {rooms.map((room) => (
                ...
                }} key={room.room_id} className={`btn transition-colors duration-300 w-full text-gray-950 dark:text-white flex justify-start items-center py-2
